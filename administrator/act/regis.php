...
@$homepage = file_get_contents("http://localhost/html_/mailtemplate.php?token=@$token&user=@$username");
  ...
  @$mail->ErrorInfo;
    ...
    header('location:http://localhost/html_/hotel_bkt/admin/checkemailjo.php');
  }
