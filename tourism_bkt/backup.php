...
<head>
   ...
   <!--  Slide -->
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA1TwYksj1uQg1V_5yPUZqwqYYtUIvidrY&sensor=true"></script>
      <!--LOADER-->
    <style>
    #loader {
                    ...
                    <section class="panel">
                        <div class="panel-body">
                           ...
                           <!--  <div style="overflow-y: auto; overflow-x:auto; margin:15px; display:flex; justify-content:center"> -->
                              <center>
                              <div class="html5gallery" style="max-height:700px; display:block;overflow: hidden;" data-skin="horizontal" data-width="350" data-height="230" data-resizemode="fit">
