  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
		      <form class="form-login" action="act/login.php" method="post">
		        <h2 class="form-login-heading" style="background:#524e4e">sign in now</h2>
		        <div class="login-wrap">       
		            ...
		            <button class="btn btn-theme btn-block" type="submit" name="submit" style="background:#524e4e;border-color:white"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
                <a href="../" class="btn btn-theme btn-block"style="background:#524e4e;border-color:white">Back
		        </div>
		      </form>	  	
