...
<body>
  <div id='container'>
    ...
    <div id='badan'>
      ...
      <a href='https://localhost/postgresql_12/tourism_bkt/admin/pages/verifikasi.php?token=$token&user=$username'>Click on this link to confirm your email</a> <!-- EDIT UNTUK HOSTING -->
    </div>
    <div id='kaki'>
  ...
  $mail->ErrorInfo;
    ...
    header('location:https://localhost/postgresql_12/tourism_bkt/admin/checkemailjo.php');
  }
