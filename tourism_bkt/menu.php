      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  <p class="centered"><a href="index.php"><img src="icon/boo.png" class="img-circle" width="100"></a></p>
              	  <b><p style="color: white; margin-top: -10px;" class="centered">Bukittinggi</p></b>

                  <li class="sub">
                      <a href="javascript:;" onclick="init();listTourism();" style="cursor:pointer;background:none">
                      <i class="fa fa-list"></i>List Tourism</a>
                  </li>

                  <li class="sub">
                      <a href="javascript:;" onclick="" style="cursor:pointer;background:none"><i class="fa fa-thumb-tack"></i>Tourism Around You</a>
                 ...
                 <!--  <li class="sub">
                  ...
                  <li class="sub-menu">
                   ...
                   <!-- <li class="sub-menu">
                      <a class="active" href=".././">
                          <i class="fa fa-users" aria-hidden="true" onclick="init();visitorreview()" style="cursor:pointer;background:none"></i>
                          <span>Visitors Review</span>
                      </a>
                  </li> -->
              </ul>
              <!-- sidebar menu end-->
